if state == 0 {
	...
	if alpha >= 1 {
		...
		var hallway = "3|aGFsbHdheQ==||||0|||0|ptX34flptX35wa04X14exflX5ptflX6exwa10X14|emX34lvemX51plemX39|0|-1";
		var hallway_node_state = new node_with_state(global.pack_editor.level_node, 0, 0, {
			level : import_level(hallway),
		});
		connect_node_states(level_node_state, hallway_node_state)
		
		connect_node_states(hallway_node_state, level_node_state)
